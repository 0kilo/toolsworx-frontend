...
export default function ImageResize_Page() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3">
          ...
          <AboutDescription
            ...
            description="Resize images to specific dimensions or percentages This conversion maintains quality and formatting while ensuring your privacy with automatic file deletion."
            sections={[
              {
                title: "How It Works",
                content: [
