...
export default function Mp3Aac_Page() {
  return (
    <div className="container py-8">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2">MP3 to AAC</h1>
            <p className="text-muted-foreground">
              Convert MP3 audio to AAC format
            </p>
          </div>
          ...
          <AboutDescription
            title="About MP3 to AAC"
            description="Convert MP3 audio to AAC format This conversion maintains quality and formatting while ensuring your privacy with automatic file deletion."
            sections={[
              {
                title: "How It Works",
                content: [
