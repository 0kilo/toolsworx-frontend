...
const category = getCategoryGroupById("media-converters")

export const metadata: Metadata = {
  title: category ? `${category.title} - ToolsWorx` : "Media Converters",
  description: category?.longDescription ?? "Convert images, audio, and video files online.",
  alternates: { canonical: "/media-converters" },
}
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <CategoryHero
        ...
        eyebrow="Media toolkit"
        chips={[`${tools.length}+ tools`, "Fast conversion", "File cleanup"]}
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-8">
        ...
        <CategorySidebar
          ...
          ctaLabel="Try the Audio Converter"
          ctaHref="/media-converters/audio"
