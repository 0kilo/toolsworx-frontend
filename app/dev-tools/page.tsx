...
const category = getCategoryGroupById("developer-tools")

export const metadata: Metadata = {
  title: category ? `${category.title} - ToolsWorx` : "Developer Tools",
  description: category?.longDescription ?? "Format, validate, and encode/decode data in-browser.",
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <CategoryHero
        ...
        chips={[`${tools.length}+ tools`, "No sign-up", "In-browser"]}
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-8">
        ...
        <CategorySidebar
          steps={[
            "Pick a tool and paste your data.",
            "Adjust options or format if needed.",
            "Copy or download the result."
          ]}
          ctaLabel="Try JSON Formatter"
          ctaHref="/dev-tools/json-formatter"
