...
const category = getCategoryGroupById("charts")

export const metadata: Metadata = {
  title: category ? `${category.title} - ToolsWorx` : "Charts & Visualizations",
  description: category?.longDescription ?? "Create interactive charts and visualizations.",
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <CategoryHero
        ...
        eyebrow="Charts studio"
        chips={[`${tools.length}+ charts`, "Interactive exports", "Presentation ready"]}
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-8">
        ...
        <CategorySidebar
          ...
          ctaLabel="Try Gantt Chart"
          ctaHref="/charts/gantt-chart"
