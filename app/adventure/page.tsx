...
const category = getCategoryGroupById("adventure")

export const metadata: Metadata = {
  title: category ? `${category.title} - ToolsWorx` : "Adventure Tools",
  description: category?.longDescription ?? "Tools for trip, route, packing, and outdoor planning.",
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <CategoryHero
        ...
        eyebrow="Trip planning suite"
        chips={[`${tools.length}+ tools`, "Field-ready", "Mobile first"]}
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-8">
        ...
        <CategorySidebar
          steps={[
            "Pick the planner you need.",
            "Fill in trip assumptions.",
            "Save the output for the trip.",
          ]}
          ctaLabel="Try Trip Cost Estimator"
          ctaHref="/adventure/trip-cost-estimator"
