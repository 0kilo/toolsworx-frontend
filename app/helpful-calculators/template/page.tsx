...
const infoContent = (
  <AboutDescription
    title="About Template Helper"
    description="Template description for helpful calculator functionality."
    sections={[
      {
        title: "How It Works",
        content: [
...
export default function TemplateHelperPage() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3">
          <CalculatorTemplate
            ...
            description="Template helper description"
            icon={Heart}
            fields={fields}
