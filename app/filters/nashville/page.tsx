...
export default function Nashville_Page() {
  return (
    <div className="container py-8">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2">Nashville Filter</h1>
            <p className="text-muted-foreground">
              Instagram Nashville filter effect
            </p>
          </div>
          ...
          <AboutDescription
            title="About Nashville Filter"
            description="Instagram Nashville filter effect This conversion maintains quality and formatting while ensuring your privacy with automatic file deletion."
            sections={[
              {
                title: "How It Works",
                content: [
