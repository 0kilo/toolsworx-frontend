...
export default function AudioEqualizer_Page() {
  return (
        ...
        <div className="lg:col-span-3">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Adjust audio frequencies with EQ
            </p>
          </div>
          ...
          <AboutDescription
            ...
            description="Adjust audio frequencies with EQ This conversion maintains quality and formatting while ensuring your privacy with automatic file deletion."
            sections={[
              {
                title: "How It Works",
                content: [
