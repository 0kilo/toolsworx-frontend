...
export default function Base64Encode_Page() {
  return (
        ...
        <div className="lg:col-span-3">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Encode files or text to Base64 format
            </p>
          </div>
          ...
          <AboutDescription
            title="About Base64 Encode"
            description="Encode files or text to Base64 format This conversion maintains quality and formatting while ensuring your privacy with automatic file deletion."
            sections={[
              {
                title: "How It Works",
                content: [
