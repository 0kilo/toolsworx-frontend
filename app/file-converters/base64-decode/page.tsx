...
export default function Base64Decode_Page() {
  return (
        ...
        <div className="lg:col-span-3">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Decode Base64 encoded files or text
            </p>
          </div>
          ...
          <AboutDescription
            title="About Base64 Decode"
            description="Decode Base64 encoded files or text This conversion maintains quality and formatting while ensuring your privacy with automatic file deletion."
            sections={[
              {
                title: "How It Works",
                content: [
