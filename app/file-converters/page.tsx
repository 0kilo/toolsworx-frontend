...
const category = getCategoryGroupById("file-converters")

export const metadata: Metadata = {
  title: category ? `${category.title} - ToolsWorx` : "File Converters",
  description: category?.longDescription ?? "Convert documents and files between formats.",
  alternates: { canonical: "/file-converters" },
}
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <CategoryHero
        ...
        eyebrow="File toolkit"
        chips={[`${tools.length}+ tools`, "Format preserving", "Auto cleanup"]}
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-8">
        ...
        <CategorySidebar
          steps={[
            "Select a converter type.",
            "Upload your file.",
            "Download the converted file."
          ]}
          ctaLabel="Try Document Converter"
          ctaHref="/file-converters/documents"
