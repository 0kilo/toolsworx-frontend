...
export default function WordPdf_Page() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3">
          ...
          <AboutDescription
            ...
            description="Convert Word documents (DOCX) to PDF format This conversion maintains quality and formatting while ensuring your privacy with automatic file deletion."
            sections={[
              {
                title: "How It Works",
                content: [
